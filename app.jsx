      ...
      {visibleCompanies.length === 0 ? (
        ...
        <div className="overflow-auto border border-rule rounded-2xl bg-paper" style={{ maxHeight: "calc(100vh - 180px)" }}>
          <table
            ...
            style={{ width: "100%", minWidth: `${120 + 180 * visibleCompanies.length}px` }}
            ...
            <thead>
              <tr>
                <th className="border border-rule p-3 text-left bg-paper sticky top-0 left-0 z-30" style={{ fontFamily: "var(--jp-serif)", fontWeight: 600 }}>
                  項目
                </th>
                {visibleCompanies.map((co) => (
...
export function DashboardView({ onNavigate }) {
  ...
  return (
    <div data-testid="dashboard-view">
      ...
      {/* PRバナー */}
      <section className="mt-8" data-testid="dashboard-ad-banner">
        <div className="flex items-baseline gap-2 mb-3">
          <span className="font-serif-en text-[10px] uppercase tracking-widest text-wood-deep border border-rule rounded-full px-2 py-0.5">
            PR
          </span>
        ...
        <div className="flex flex-wrap justify-center gap-6">
          <div className="flex flex-col items-center gap-2 w-[260px] max-w-full">
            ...
            <a href="https://px.a8.net/svt/ejp?a8mat=4BA0XD+6NXRVU+2ISC+60OXD" target="_blank" rel="noopener nofollow">
              <img border="0" width="350" height="240"
                alt="木の家・自然素材住宅の工務店が探せる無料一括資料請求"
                src="https://www29.a8.net/svt/bgt?aid=260808241403&wid=004&eno=01&mid=s00000011766001011000&mc=1" />
            </a>
          ...
          <div className="flex flex-col items-center gap-2 w-[260px] max-w-full">
            ...
            <a href="https://px.a8.net/svt/ejp?a8mat=4BA1PB+728436+136+1BSOG1" target="_blank" rel="noopener nofollow">
              <img border="0" width="300" height="250"
                alt="SUUMO 新築マンション・一戸建て購入者アンケート"
                src="https://www26.a8.net/svt/bgt?aid=260809247427&wid=001&eno=01&mid=s00000000141008028000&mc=1" />
            </a>
          ...
          <div className="flex flex-col items-center gap-2 w-[260px] max-w-full">
            ...
            <a href="https://px.a8.net/svt/ejp?a8mat=4BA4TC+M125U+5M4Y+5YZ75" target="_blank" rel="noopener nofollow">
              <img border="0" width="300" height="250"
                alt=""
                src="https://www29.a8.net/svt/bgt?aid=260813280037&wid=001&eno=01&mid=s00000026197001003000&mc=1" />
            </a>
            <img border="0" width="1" height="1" src="https://www12.a8.net/0.gif?a8mat=4BA4TC+M125U+5M4Y+5YZ75" alt="" style={{ position: "absolute" }} />
          </div>
        </div>
      </section>
    </div>
